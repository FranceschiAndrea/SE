 ...
 * generated in the com.anfropippo.soapserver package. 
...
public class ObjectFactory {
    ...
    private final static QName _GetClients_QNAME = new QName("http://myaaawsserver.mycompany.com/", "getClients");
    private final static QName _GetClientsResponse_QNAME = new QName("http://myaaawsserver.mycompany.com/", "getClientsResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.anfropippo.soapserver
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://myaaawsserver.mycompany.com/", name = "getClients")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://myaaawsserver.mycompany.com/", name = "getClientsResponse")
